...
public class MainActivity23 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    String[] an1={"Maninagar", "Shivranjini", "Jhansi ki Rani", "Nehrunagar", "Himmatlaal park", "Anjali", "Memnagar",};
    String[] an2={"Maninagar", "Shivranjini", "Jhansi ki Rani", "Nehrunagar", "Himmatlaal park", "Anjali", "Memnagar",};
    Button b1;
    Spinner sp,sp1;
    String sps,sps1,l1;
    ListView lv;
       ...
       // new getBusId().execute();
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sps1 = sp1.getSelectedItem().toString();
...
//            Log.v("Home", "############################You are not online!!!!");
                try {
                    AlertDialog alertDialog = new AlertDialog.Builder(MainActivity23.this).create();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                NavUtils.navigateUpFromSameTask(MainActivity23.this);
                return true;
            default:
    ...
    {
        Intent intent = new Intent(MainActivity23.this, Main2Activity.class);
        startActivity(intent);
    }*/

    public class AsyncTaskJson extends AsyncTask<String,Void,String> {

        String jsonurl="http://raju1221.dx.am/dispSD.php";
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading= ProgressDialog.show(MainActivity23.this, "Please Wait", "Loading..");
        }
      ...
      ArrayList<NameValuePair> al=new ArrayList<NameValuePair>();
            ...
            al.add(new BasicNameValuePair("src",sps));

            al.add(new BasicNameValuePair("des",sps1));
        ...
        protected void onPostExecute(String result) {
            ...
            else
            {
                ...
                BusAdp midAdp=new BusAdp(getApplicationContext(),arrayList);
    ...
    public class getBusId extends  AsyncTask<String,Void,String>
    {
        ...
        String jsonurl="http://raju1221.dx.am/fetchBusMid.php";
        public getBusId() {
            super();
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++)
                {
                    ...
                    String src=c.getString("busSource");

                    arrayList.add(src);

                    String des=c.getString("busDestination");

                    arrayList1.add(des);
                }

                ArrayAdapter aa=new ArrayAdapter(MainActivity23.this,android.R.layout.simple_spinner_item,arrayList);
                aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                sp.setAdapter(aa);
                ArrayAdapter aa1=new ArrayAdapter(MainActivity23.this,android.R.layout.simple_spinner_item,arrayList1);
    ...
    public class AsyncTaskJson1 extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result) {
            ...
            AlertDialog.Builder alertDialog1 = new AlertDialog.Builder(MainActivity23.this);
    ...
    public class BusAdp extends BaseAdapter {
        ...
        public Object getItem(int position) {
            return arrayList.get(position).getBus();
        }
