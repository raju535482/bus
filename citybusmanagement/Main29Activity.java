...
public class Main29Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mywebview.loadUrl("http://raju1221.dx.am/index.php");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.home:
                NavUtils.navigateUpFromSameTask(Main29Activity.this);
                return true;
            default:
    ...
    public class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        private boolean isNetworkAvailable(final Context context) {
            ...
            try {
                AlertDialog alertDialog = new AlertDialog.Builder(Main29Activity.this).create();
